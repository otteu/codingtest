...
public class TimeSubstring3 {
    public static void main(String[] args) throws FileNotFoundException {

        // 시간이 얼마나 지났는가 ?
        File file = new File("src/file/questions/time_substring3.txt");
        ...
        String lateTime = String.format("%02d:%02d:%02d", needHour, needMinute, needSecond);
